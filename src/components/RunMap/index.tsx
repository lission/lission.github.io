...
const RunMap = ({
  ...
  return (
    <div className="bg-white/40 backdrop-blur-md rounded-ghibli p-2 shadow-sm border border-white/60">
      <Map
        {...viewState}
        onMove={onMove}
        style={style}
      ...
      >
        ...
        <NavigationControl showCompass={false} position={'bottom-right'} style={{opacity: 0.5}}/>
      </Map>
    </div>
  );
};
